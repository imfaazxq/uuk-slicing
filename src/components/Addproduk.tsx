  ...
  return (
    <>
      <div className="flex w-full h-screen">
        ...
        {/* Main Content */}
        <div className="container bg-white py-13 px-10 shadow-lg max-w-screen-md mx-auto rounded-md">
          <div className="text-center mb-8">
            <h1 className="font-bold text-3xl mt-5">Add Product</h1>
            <hr className="border-gray-400 mb-8 mt-2" />
          </div>
          <div className="flex flex-wrap">
            <div className="w-full lg:w-1/2 flex mb-8 justify-center">
              <h1 className="font-bold mb-2 text-3xl text-gray-500">Product</h1>
            </div>
            <div className="text-center lg:w-1/2">
              <form action="">
                ...
                <div className="w-full px-4 mb-8 text-center">
                  <label className="mr-2 text-gray-600">Condition:</label>
                  <label className="mr-2">
                    <input type="radio" name="condition" value="Good" className="mr-1" /> Good
                  </label>
                  <label>
                    <input type="radio" name="condition" value="Damaged" className="mr-1" /> Damaged
                  </label>
                </div>
